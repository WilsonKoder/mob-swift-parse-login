...
SWIFT_CLASS("_TtC8yourFeed11AppDelegate")
...
SWIFT_CLASS("_TtC8yourFeed19FirstViewController")
...
SWIFT_CLASS("_TtC8yourFeed20SecondViewController")
...
@property (nonatomic) IBOutlet UITextField * textFieldEmail;
@property (nonatomic) IBOutlet UITextField * textFieldLoginUsername;
@property (nonatomic) IBOutlet UITextField * textFieldLoginPassword;
@property (nonatomic) BOOL isLoggedIn;
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (IBAction)signUpButtonTouchUp:(id)sender;
